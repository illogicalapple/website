<template>
	...
	<main id="content">
		<div style="text-align: center; transform: translateY(-50%); position: absolute; top: 50%; width: 100%;">
			<h1 style="font-size: 20vmin; background: url(/apples.png); background-clip: text; -webkit-background-clip: text; color: transparent; background-position: center 20px;">404</h1>
